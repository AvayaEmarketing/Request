...
public partial class report : System.Web.UI.Page
{
    ...
    public static string getDatosReg()
    {
        ...
        //{
            ...
            if (values != null)
            {
                ...
                {
                    jsonarmado += "{\"solicit_id\": \"" + root.solicit_id + "\", \"S_key_name\": \"" + root.S_key_name + "\",\"solicitante\": \"<p style=\'position:relative;text-align:center;width:100%;\'><img  width=\'50\' height=\'50\' title=\'" + root.solicitante + "\' src=\'images/" + root.f_solicitante + "\'/></p>\",\"original\": \"" + root.S_original_language + "\",\"translate\": \"" + root.S_translate_language + "\",\"estado\": \"" + root.estado + "\",\"S_register_date2\": \"" + root.S_register_date2 + "\",\"T_Fecha_Estimada2\": \"" + root.T_Fecha_Estimada2 + "\",\"S_Fecha_modificacion\": \"" + root.S_Fecha_modificacion + "\",\"InCharge\": \"<p style=\'position:relative;text-align:center;width:100%;\'><img style=\'text-align:center;\' width=\'50\' height=\'50\' title=\'" + root.InCharge + "\' src=\'images/" + root.f_responsable + "\'/></p>\",\"duration\": \"" + duration + "\"},";
                }
            }
    ...
    public static string getDatosRequest()
    {
        ...
        string strSQL = "SELECT solicit_id,S_key_name,solicitante,S_original_language,S_translate_language,f_solicitante,estado,S_register_date2,T_Fecha_Estimada2,S_Fecha_modificacion,InCharge,f_responsable FROM t_requests";
