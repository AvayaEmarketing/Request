...
public partial class trad_details : System.Web.UI.Page
{
    ...
    public static string getInfo()
    {
        ...
        {
            result = "fail";
            WriteError(ex.Message, "trad_details.aspx", "getInfo");
        }
        finally
        {
            con.Close();
    ...
    public static int getId(SqlConnection con, string consulta)
    {
        ...
        {
            id = -1;
            WriteError(ex.Message, "trad_details.aspx", "getId");
        }
        finally
        {
            con.Close();
    ...
    public static string cerrarSession()
    {
        ...
        {
            resultado = "fail";
            WriteError(ex.Message, "trad_details.aspx", "cerrarSession");
        }
        return resultado;
    }
