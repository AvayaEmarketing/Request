s<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rev_details.aspx.cs" Inherits="rev_details" %>
...
<head>
    ...
    <script type="text/javascript" src="js/rev_details.js"></script>
                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="rev_details.aspx" id="information">Information</a></li>
